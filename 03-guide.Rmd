...
knitr::include_graphics("images/module_inpute.png")
```
...
knitr::include_graphics("images/input_step.png")
```
...
```{r out.width='60%', fig.align = 'center', echo=F}
knitr::include_graphics("images/calibration_step.png")
```
...
```{r out.width='60%', fig.align = 'center',echo=F}
knitr::include_graphics("images/filtering_step.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/sumexp.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/taxabarplot.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/DA.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/enrichment.png")
```

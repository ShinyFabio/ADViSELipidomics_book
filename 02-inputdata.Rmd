...
knitr::include_graphics("images/notation_files.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/target_file_example.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/nomenclature.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/internal_reference_example.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/int_reference_LIQUID.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/calibration_deut_example.png")
```
...
```{r out.width='100%', echo=F}
knitr::include_graphics("images/excel_file_example.png")
```
